...
window.onload = function() {
	var renderer, materialsLibrary, svgMeshBuilder;
	...
	function init() {
		...
		svgMeshBuilder = new SvgMeshBuilder(materialsLibrary);

		currentMesh = new TubeMeshParams().create();
		loop = new Loop(materialsLibrary);

		sceneWrapper = new SceneWrapper(tubeMeshBuilder, materialsLibrary.textureCube, currentMesh, svgMeshBuilder);
